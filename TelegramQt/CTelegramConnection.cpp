  ...
  #endif
{
    ...
    m_dhLayer = new ClientDhLayer(this);
    connect(m_dhLayer, &ClientDhLayer::stateChanged, this, &CTelegramConnection::onDhStateChanged);
}
...
{
    if (m_dhLayer->state() == ClientDhLayer::State::HasKey) {
